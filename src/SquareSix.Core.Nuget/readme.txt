...
Thank you for installing SquareSix.Core. Samples on how to use this package and/or release notes can be found at: https://github.com/Square-Six/SquareSix.Core
